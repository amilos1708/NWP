...
<html>
	<head>
        ...
        <meta name="author" content="andrejmilos]mail.hr">
		<!-- favicon meta -->
...
<body>
	...
	# Send Contact1
	else if ($menu == 12) { include("send-contact2.php"); }
	
	print '
	</main>
	<footer>
		<p>Copyright &copy; ' . date("Y") . ' Andrej Milos. <a href="https://github.com/amilos1708" style="color:#fff">GITHub</a></p>
	</footer>
</body>
</html>';
?>
